...
class AtariRAMEnv(Env):
    ...
    def __init__(self,
        ...
        # Spaces
        self.bits = bits
        self.preprocess = (lambda x: np.unpackbits(x)[..., None, None]*255) if self.bits\
    ...
    def _update_obs(self):
        ...
        self._obs = np.concatenate([self._obs[1:], self._raw_frame[np.newaxis]])
